...
//    function UntilDate: TDateTime;
  ...
  ItdChatMemberUpdated = Interface //New in API 5.1
    ...
    function invite_link:	ItdChatInviteLink;
  End;
  ItdVoiceChatScheduled = Interface //New in API 5.2
  ...
  End;
  ItdVoiceChatStarted = Interface //New in API 5.1
    ['{9877BC33-72C7-4BC9-B462-C1D5E90EF902}']
  End;
  ItdVoiceChatEnded = Interface //New in API 5.1
    ['{B769F63E-11FA-42D0-9DAF-6AC9B41FB5E5}']
    function duration:	Integer;
  End;
  ItdVoiceChatParticipantsInvited = Interface //New in API 5.1
