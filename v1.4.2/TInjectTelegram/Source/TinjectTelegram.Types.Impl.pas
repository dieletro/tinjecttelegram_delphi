...
//  end;
  ...
  public
    constructor Create(const ANumeroTelelefone, APrimeiroNome, UltimoNome, AVCard: String); reintroduce; overload;
...
function TtdStickerSet.Thumb: ItdPhotoSize;
begin
  Result := ReadToClass<TtdPhotoSize>('thumb');
end;
...
constructor TtdContact.Create(const ANumeroTelelefone, APrimeiroNome, UltimoNome, AVCard: String);
begin
...
procedure TtdContact.SetVCard(const Value: string);
begin
  FJson := '{"vacard":"'+Value+'",';
end;
...
function TtdContact.VCard: string;
begin
