...
begin
  Result := ReadToInterfaceArray<IphNode>(TphNode, 'children');
end;
...
begin
  Result := ReadToInterfaceArray<IphNode>(TphPage, 'content')
end;
...
begin
  Result := ReadToInterfaceArray<IphNode>(TphNode, 'pages');
end;
