...
{$REGION 'Basic methods'}
    ...
    function SendMessage( //
      ...
      const MessageThreadId: int64 = 0): ItdMessage;
    ///<summary >
    ...
    function SendPhoto( //
      ...
      const HasSpoiler: boolean = False): ItdMessage;
    /// <summary>
    ...
    function SendAudio( //
      ...
      const ProtectContent: Boolean = False;
      const MessageThreadId: int64 = 0;
      const CaptionEntities: TArray<TtdMessageEntity> = []): ItdMessage;
    /// <summary>
    ...
    function SendChatAction( //
      ...
      const MessageThreadId: int64 = 0): Boolean;
    ...
    function sendMediaGroup( //
      ...
      const ReplyParameters: ItdReplyParameters = nil;
      const ProtectContent: Boolean = False;
      const MessageThreadId: int64 = 0): TArray<ItdMessage>;
    /// <summary>
...
{$REGION 'Strickers'}
    ...
    function createNewStickerSet( //
      ...
      const sticker_format: TtdStickerFormat;
    ...
    function setStickerSetThumbnail(
        const Name: string;
        const UserId: Int64;
        const Thumbnail: string): Boolean;
    /// <summary>
...
function TInjectTelegramBot.SendLocation(
  ...
  const MessageThreadId: int64): ItdMessage;
begin
...
function TInjectTelegramBot.sendMediaGroup(const ChatId: TtdUserLink;
  ...
  const ReplyParameters: ItdReplyParameters;
  const ProtectContent: Boolean;
  const MessageThreadId: int64): TArray<ItdMessage>;
var
...
function TInjectTelegramBot.SendPhoto(
  ...
  const CaptionEntities: TArray<TtdMessageEntity>;
  const HasSpoiler: Boolean): ItdMessage;
var
  LTmpJson: string;
begin
...
function TInjectTelegramBot.SendMessage(const ChatId: TtdUserLink; const Text: string;
  const ParseMode: TtdParseMode; const LinkPreviewOptions : ItdLinkPreviewOptions;
  const DisableNotification: Boolean; const ReplyParameters: ItdReplyParameters;
...
function TInjectTelegramBot.SendVideoNote(const ChatId: TtdUserLink; const VideoNote:
  ...
  const ReplyMarkup: IReplyMarkup;
      const ProtectContent: Boolean;const MessageThreadId: int64): ItdMessage;
begin
...
function TInjectTelegramBot.SendChatAction(const ChatId: TtdUserLink; const Action:
  TtdSendChatAction; const MessageThreadId: int64): Boolean;
begin
...
begin
  ...
  Result := GetRequest.SetMethod('createNewStickerSet') //
    ...
    .AddParameter('sticker_format', sticker_format.ToString, '', False) //
...
function TInjectTelegramBot.setStickerSetThumbnail(const Name: string;
  const UserId: Int64; const Thumbnail: string): Boolean;
begin
