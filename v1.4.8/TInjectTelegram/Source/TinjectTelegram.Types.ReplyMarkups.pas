...
type
  ...
  private
    ...
    [JSONName('request_username')]
    Frequest_username: Boolean;
    [JSONName('request_photo')]
    Frequest_photo: Boolean;
    [JSONName('request_name')]
    Frequest_name: Boolean;
  public
    ...
    property request_name: Boolean read Frequest_name write Frequest_name;
    property request_username: Boolean read Frequest_username write Frequest_username;
    property request_photo: Boolean read Frequest_photo write Frequest_photo;
  ...
  private
    ...
    [JSONName('request_title')]
    Frequest_title: Boolean;
    [JSONName('request_username')]
    Frequest_username: Boolean;
    [JSONName('request_photo')]
    Frequest_photo: Boolean;
  public
    ...
    property request_title: Boolean read Frequest_title write Frequest_title;
    property request_username: Boolean read Frequest_username write Frequest_username;
    property request_photo: Boolean read Frequest_photo write Frequest_photo;
    constructor Create(const Arequest_id: integer); overload;
  end;

  TtdSwitchInlineQueryChosenChat = class(TInterfacedObject, IReplyMarkup)
  private
    FQuery: string;
  ...
  public
   ...
   property allow_user_chats: Boolean read Fallow_user_chats write Fallow_user_chats;
   property allow_bot_chats: Boolean read Fallow_bot_chats write Fallow_bot_chats;
   property allow_group_chats: Boolean read Fallow_group_chats write Fallow_group_chats;
   property allow_channel_chats: Boolean read Fallow_channel_chats write Fallow_channel_chats;
...
constructor TtdSwitchInlineQueryChosenChat.Create;
begin
inherited Create();
end;
