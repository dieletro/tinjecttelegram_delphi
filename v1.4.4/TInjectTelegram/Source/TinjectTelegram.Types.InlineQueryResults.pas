...
type
  ...
  /// </summary>
  [JSONName('InlineQueryResultsButton')]
  ...
  public
    ...
    /// </summary>
    [JSONName('web_app')]
    WebApp: ItdWebAppInfo;

    /// <summary>
    ///   Optional. Deep-linking parameter for the /start message sent to the
    ///   bot when a user presses the button. 1-64 characters,
    ///   only A-Z, a-z, 0-9, _ and - are allowed.
    /// </summary>
    [JSONName('start_parameter')]
  ...
  public
    ...
    /// </summary>
    [JSONName('thumbnail_width')]
    Thumbnail_width: Integer;
    /// <summary>
    ///   Optional. Thumbnail height
    /// </summary>
    [JSONName('thumbnail_height')]
  ...
  TtdInlineQueryResultPhoto = class(TtdInlineQueryResult) //TtdInlineQueryResult //TtdInlineQueryResultNew
  public
    /// <summary>
  ...
  TtdInlineQueryResultVideo = class(TtdInlineQueryResult) //TtdInlineQueryResultNew
  public
    /// <summary>
