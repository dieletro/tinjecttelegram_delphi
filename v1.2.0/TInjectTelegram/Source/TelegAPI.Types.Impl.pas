...
type
  ...
  TtgChatPermissions = class(TBaseJson, ItgChatPermissions)
  public
    function CanSendMessages:	Boolean;
    function CanSendMediaMessages: Boolean;
    function CanSendPolls:	Boolean;
  ...
  TtgChatLocation = class(TBaseJson, ItgChatLocation)
  public
  ...
  //New in API 5.0
  TtgProximityAlertTriggered = class(TBaseJson, ItgProximityAlertTriggered)
  public
    function traveler:	ItgUser;  //	User that triggered the alert
    function watcher:	  ItgUser;  //	User that set the alert
...
function TtgFile.FileUniqueId: string;
begin
...
function TTgMessage.ForwardSenderName: String;
begin
...
function TTgMessage.ProximityAlertTriggered: ItgProximityAlertTriggered;
begin
  Result := ReadToClass<TtgProximityAlertTriggered>('proximity_alert_triggered');
end;
...
function TTgMessage.SenderChat: ItgChat;
begin
  Result := ReadToClass<TtgChat>('sender_chat');
end;
...
function TtgLocation.GetHeading: Integer;
begin
  Result := ReadToSimpleType<Integer>('heading');
  FHeading := Result;
end;

function TtgLocation.GetHorizontalAccuracy: Single;
begin
...
function TtgLocation.GetLivePeriod: Integer;
begin
...
function TtgLocation.GetProximityAlertRadius: Integer;
begin
  Result := ReadToSimpleType<Integer>('proximity_alert_radius');
  FProximityAlertRadius := Result;
end;

procedure TtgLocation.SetHeading(const Value: Integer);
begin

end;

procedure TtgLocation.SetHorizontalAccuracy(const Value: Single);
begin
...
procedure TtgLocation.SetLivePeriod(const Value: Integer);
begin
...
procedure TtgLocation.SetProximityAlertRadius(const Value: Integer);
begin
...
function TtgChatMember.CanSendPolls: Boolean;
begin
  Result := ReadToSimpleType<Boolean>('can_send_polls');
end;

function TtgChatMember.CustomTitle: String;
begin
  Result := ReadToSimpleType<String>('custom_title');
end;

function TtgChatMember.IsAnonymous: Boolean;
begin
  Result := ReadToSimpleType<Boolean>('is_anonymous');
end;

function TtgChatMember.IsMember: Boolean;
begin
...
function TtgChat.LinkedChatId: Integer;
begin
  Result := ReadToSimpleType<Integer>('linked_chat_id');
end;

function TtgChat.location: ItgChatLocation;
begin
  Result := ReadToClass<TtgChatLocation>('location');
end;

function TtgChat.Permissions: ItgChatPermissions;
begin
  Result := ReadToClass<TtgChatPermissions>('ChatPermissions');
end;
...
function TtgChat.SlowModeDelay: Integer;
begin
...
function TtgWebhookInfo.IpAddress: String;
begin
...
function TtgAudio.FileName: string;
begin
  Result := ReadToSimpleType<string>('file_name');
end;
...
function TtgVideo.FileName: string;
begin
  Result := ReadToSimpleType<string>('file_name');
end;
...
function TtgVenue.google_place_id: string;
begin
  Result := ReadToSimpleType<string>('google_place_id');
end;

function TtgVenue.google_place_type: string;
begin
...
procedure TtgVenue.SetGooglePlaceId(const Value: string);
begin
  FGooglePlaceId := Value;
end;

procedure TtgVenue.SetGooglePlaceType(const Value: String);
begin
...
{ TtgProximityAlertTriggered }

function TtgProximityAlertTriggered.distance: Integer;
begin
  Result := ReadToSimpleType<Integer>('distance');
end;

function TtgProximityAlertTriggered.traveler: ItgUser;
begin
  Result := ReadToClass<TtgUser>('traveler');
end;

function TtgProximityAlertTriggered.watcher: ItgUser;
begin
  Result := ReadToClass<TtgUser>('watcher');
end;

{ TtgChatPermissions }

function TtgChatPermissions.CanAddWebPagePreviews: Boolean;
begin
  Result := ReadToSimpleType<Boolean>('can_add_web_page_previews');
end;

function TtgChatPermissions.CanChangeInfo: Boolean;
begin
  Result := ReadToSimpleType<Boolean>('can_change_info');
end;

function TtgChatPermissions.CanInviteUsers: Boolean;
begin
  Result := ReadToSimpleType<Boolean>('can_invite_users');
end;

function TtgChatPermissions.CanPinMessages: Boolean;
begin
  Result := ReadToSimpleType<Boolean>('can_pin_messages');
end;

function TtgChatPermissions.CanSendMediaMessages: Boolean;
begin
  Result := ReadToSimpleType<Boolean>('can_send_media_messages');
end;

function TtgChatPermissions.CanSendMessages: Boolean;
begin
  Result := ReadToSimpleType<Boolean>('can_send_messages');
end;

function TtgChatPermissions.CanSendOtherMessages: Boolean;
begin
  Result := ReadToSimpleType<Boolean>('can_send_other_messages');
end;

function TtgChatPermissions.CanSendPolls: Boolean;
begin
  Result := ReadToSimpleType<Boolean>('can_send_polls');
end;
...
function TtgChatLocation.Address: String;
begin
  Result := ReadToSimpleType<String>('address');
end;

function TtgChatLocation.Location: ItgLocation;
begin
  Result := ReadToClass<TtgLocation>('location');
end;
