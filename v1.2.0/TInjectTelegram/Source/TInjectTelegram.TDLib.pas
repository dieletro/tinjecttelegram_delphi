...
type
  {IInjectTelegramTDLib}
  IInjectTelegramTDLib = interface
    ...
    function GetPhoneNumber: AnsiString;
    procedure SetPhoneNumber(const Value: AnsiString);

    function GetAPIid: Integer;
    procedure SetAPIid(const Value: Integer);
...
{$REGION 'Getting updates'}
    ...
    function GetUpdates(const JSON: string): TArray<ItgUpdate>; overload;
    /// <summary>
...
{$REGION 'Basic methods'}
    ...
    function SendVenue( //
      ...
      const Location: TtgLocation; //Add Para Testes
      const DisableNotification: Boolean = False; //
      const ReplyToMessageId: Int64 = 0; //
      ReplyMarkup: IReplyMarkup = nil): ITgMessage;
    /// <summary>
    ...
    function SendPoll( //
      ...
      const &type: TtgQuizType = TtgQuizType.qtPadrao;//String = '"regular"'; //regular ou quiz
...
{$ENDREGION}
    ...
    property APIid: Integer read GetAPIid write SetAPIid;
    property APIHash: String read GetAPIHash write SetAPIHash;
