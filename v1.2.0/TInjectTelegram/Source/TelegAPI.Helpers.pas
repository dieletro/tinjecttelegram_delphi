...
type
  ...
  TSendPollHelper = record helper for TtgQuizType
    function ToString: string;
  End;

  TSendHelper = record helper for TtgMessageEntityType
    function ToString: string;
  end;
...
begin
  case Self of
    ...
    TtgEmojiType.etBasquete:
        Result  := '🏀';
    TtgEmojiType.etFootball:
        Result  := '⚽';
    TtgEmojiType.etSlotMachine:
        Result  := '🎰';
  end;
end;
...
begin
  case Self of
    TtgQuizType.qtPadrao:
      result := 'regular';
    TtgQuizType.qtRegular:
      result := 'regular';
    TtgQuizType.qtQuiz:
      result := 'quiz';
  end;
...
begin
  case Self of
    TtgMessageEntityType.mention:
      result := 'mention';
    TtgMessageEntityType.hashtag:
      result := 'hashtag';
    TtgMessageEntityType.cashtag:
      result := 'cashtag';
    TtgMessageEntityType.bot_command:
      result := 'bot_command';
    TtgMessageEntityType.url:
      result := 'url';
    TtgMessageEntityType.email:
      result := 'email';
    TtgMessageEntityType.phone_number:
      result := 'phone_number';
    TtgMessageEntityType.bold:
      result := 'bold';
    TtgMessageEntityType.italic:
      result := 'italic';
    TtgMessageEntityType.underline:
      result := 'underline';
    TtgMessageEntityType.strikethrough:
      result := 'strikethrough';
    TtgMessageEntityType.code:
      result := 'code';
    TtgMessageEntityType.pre:
      result := 'pre';
    TtgMessageEntityType.text_link:
      result := 'text_link';
    TtgMessageEntityType.text_mention:
      result := 'text_mention';
    TtgMessageEntityType.N_A:
      result := '';
  end;
end;
