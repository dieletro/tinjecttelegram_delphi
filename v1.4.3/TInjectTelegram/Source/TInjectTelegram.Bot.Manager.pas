...
type
  ...
  /// </remarks>
    ...
    [Default(1)]
    property InactivityTime: Integer read FTempoInatividade write FTempoInatividade;
  ...
  begin
    ...
    Begin
      ...
      Begin
        ...
        FLimit := IncMinute(AConversa.LastIteration, ABotManager.InactivityTime);
        ...
        Begin
          ...
          Begin
            ...
            AConversa.LastIteration := IncSecond(FTimeNow, FTimeOutSeconds);
...
begin
  ...
  begin
    ...
    if Self.InactivityTime <> 0 then
    Begin
      FTimeNow := StrToTime(FormatDateTime('hh:mm:ss',Now));
      FLimit := IncMinute(AConversa.LastIteration, Self.InactivityTime);
