...
type
  ...
  private
    ...
    FInatividadeNotificada: Boolean;
    FIdConversa: Int64;
  public
    FMessage : ItdMessage;
  ...
  published
    function LoadButtons(AQuery: TFDQuery; AFieldName: String;
      AInitZero: Boolean = True) : IReplyMarkup;
    function LoadButtonsStr(AStrArrayBtName: TArray<TArray<String>>;
      AInlineMode: Boolean = false) : IReplyMarkup;
    //Proprieades
    [Default(0)]
    property  UserType           : TtdTipoUsuario          read FTipoUsuario       write FTipoUsuario {default tpCliente};
    [Default(0)]
    property  ServiceSituation   : TtdSituacaoAtendimento  read FSituacao          write SetSituacao  {default saIndefinido};
    [Default(0)]
    property  ServiceStage       : TtdEtapasAtendimento    read FEtapaAtendimento  write FEtapaAtendimento {default pvListarMenu};
    [Default(0)]
    property  Stage              : Integer               read FEtapa             write FEtapa {default 0};
    property  ConversationID     : Int64                 read FIdConversa        write FIdConversa;
    property  Tipo               : string                read FTipo              write FTipo;
    property  ID                 : String                read FID                write FID;
    property  IdIdiomaStr        : String                read FIdIdiomaStr       write FIdIdiomaStr;
    property  OrderID            : Integer               read FIdPedido          write FIdPedido;
    property  ClientID           : Int64                 read FIdCliente         write FIdCliente;
    property  ChatID             : Int64                 read FIdChat            write FIdChat;
    property  IDInc              : Integer               read FIDInc             write FIDInc;
    property  MSGText            : String                read FTextoMSG          write FTextoMSG;
    property  Name               : String                read FNome              write FNome;
    property  OrderItems         : TStringList           read FItemsPedido       write FItemsPedido;
    property  HighestValue       : Currency              read FMaiorValor        write FMaiorValor;
    property  DeliveryAddress    : String                read FEnderecoEntrega   write FEnderecoEntrega;
    property  NumberAdress       : String                read FNumero            write FNumero;
    property  PostalCodeAdress   : String                read FCep               write FCep;
    property  PublicPlace        : String                read FLogradouro        write FLogradouro;
    property  Neighborhood       : String                read FBairro            write FBairro;
    property  Location           : String                read FLocalidade        write FLocalidade;
    property  UF                 : String                read FUF                write FUF;
    property  ReferencePoint     : String                read FPontoReferencia   write FPontoReferencia;
    property  DistanceKM         : String                read FDistanciaKM       write FDistanciaKM;
    property  DurationMIN        : String                read FDuracaoMIN        write FDuracaoMIN;
    property  DeliveryFee        : Real                  read FTaxaEntrega       write FTaxaEntrega;
    property  Latitude           : Single                read FLatitude          write FLatitude;
    property  Longitude          : Single                read FLongetude         write FLongetude;
    property  PaymentOrigin      : String                read FFormaPGT          write FFormaPGT;
    property  TotalOrder         : Real                  read FTotalPedido       write FTotalPedido;
    property  Description        : String                read FDescricao         write FDescricao;

    [Default('')]
    property  ReceivedFile       : String                read FArquivoRecebido   write FArquivoRecebido;
    property  LastIteration      : TTime                 read FUltimaIteracao    write FUltimaIteracao;
    property  NotifiedInactivity   : Boolean          read FInatividadeNotificada  write FInatividadeNotificada;
    property  InactivityTime     : Integer               read FTempoInatividade  write SetTempoInatividade;
    property  Message_           : ItdMessage            read FMessage;
    //Eventos
    property OnChangedSituation: TNotifyTelegramBotConversa read FOnSituacaoAlterada write FOnSituacaoAlterada;
...
function TInjectTelegramChat.LoadButtonsStr(AStrArrayBtName: TArray<TArray<String>>;AInlineMode: Boolean = false) : IReplyMarkup;
var
  {$REGION 'VARIAVEIS'}
  I, O: Integer;
  str: String;
...
End;
function TInjectTelegramChat.LoadButtons(AQuery: TFDQuery; AFieldName: String; AInitZero: Boolean = True) : IReplyMarkup;
var
  {$REGION 'VARIAVEIS'}
  I: Integer;
  strTexto : String;
...
procedure TInjectTelegramChat.RestartTimer;
begin
...
//    if Value <> TtdSituacaoAtendimento.saInativa then
    ...
    if FSituacao <> Value then
      FSituacao := Value;
    if Assigned( OnChangedSituation ) then
      OnChangedSituation(Self, FMessage);
  end;
end;
