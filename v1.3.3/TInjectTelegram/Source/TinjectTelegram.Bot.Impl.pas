...
{$REGION 'Basic methods'}
    ...
    function GetChatMembersCount(const ChatId: TtdUserLink): Int64;
...
{$REGION 'BotCommands'}
    function SetMyCommands(Command: TArray<TtdBotCommand>): Boolean;
    function GetMyCommands: TArray<TtdBotCommand>;
...
{$REGION 'ChatInviteLink'}
    function createChatInviteLink( //
      ...
      const member_limit: Integer = 0): ItdChatInviteLink;
...
{$REGION 'Strickers'}
    ...
    function getStickerSet(const Name: string): TtdStickerSet;
    ...
    function createNewStickerSet( //
      ...
      const MaskPosition: TtdMaskPosition = nil): Boolean;
...
function TInjectTelegramBot.editChatInviteLink(const ChatId: TtdUserLink;
  ...
  const member_limit: Integer): ItdChatInviteLink;
begin
...
function TInjectTelegramBot.SendVenue(const ChatId: TtdUserLink; const Venue: TtdVenue;
  const Location: TtdLocation; const DisableNotification: Boolean;
...
function TInjectTelegramBot.SendVenue2(const ChatId: TtdUserLink;
  const Venue: TtdVenue; const DisableNotification: Boolean;
...
function TInjectTelegramBot.SendContact(const ChatId: TtdUserLink; const Contact:
  TtdContact; const DisableNotification: Boolean; const ReplyToMessageId: Int64;
  const AllowSendingWithoutReply:	Boolean;
  ReplyMarkup: IReplyMarkup): ItdMessage;
begin
...
function TInjectTelegramBot.SetMyCommands(Command: TArray<TtdBotCommand>): Boolean;
Var
  LTmpJson: String;
begin
  LTmpJson := TJsonUtils.ArrayToJString<TtdBotCommand>(Command);
...
function TInjectTelegramBot.GetMyCommands: TArray<TtdBotCommand>;
begin
  Logger.Enter(Self, 'GetMyCommands');
  Result := GetArrayFromMethod<TtdBotCommand>(TtdBotCommand,
...
function TInjectTelegramBot.GetChatMembersCount(const ChatId: TtdUserLink): Int64;
var
  LJSON: TJSONValue;
begin
...
function TInjectTelegramBot.editMessageLiveLocation(const ChatId: TtdUserLink; const
  MessageId: Int64; const Location: TtdLocation; ReplyMarkup: IReplyMarkup): Boolean;
begin
...
function TInjectTelegramBot.editMessageLiveLocation(const InlineMessageId: string;
  const Location: TtdLocation; ReplyMarkup: IReplyMarkup): Boolean;
begin
  Logger.Enter(Self, 'editMessageLiveLocation');
  Result := GetRequest.SetMethod('editMessageLiveLocation') //
    .AddParameter('inline_message_id', InlineMessageId, 0, True) //
...
function TInjectTelegramBot.addStickerToSet(const UserId: Int64; const Name: string;
  const PngSticker: TtdFileToSend;const TgsSticker: TtdFileToSend; const Emojis: string; const MaskPosition:
  TtdMaskPosition): Boolean;
begin
...
function TInjectTelegramBot.createChatInviteLink(const ChatId: TtdUserLink;
  const expire_date: TDateTime; const member_limit: Integer): ItdChatInviteLink;
begin
...
function TInjectTelegramBot.createNewStickerSet(const UserId: Int64; const Name, Title:
  string; const PngSticker: TtdFileToSend; const TgsSticker: TtdFileToSend; const Emojis: string; const
  ContainsMasks: Boolean; const MaskPosition: TtdMaskPosition): Boolean;
begin
...
function TInjectTelegramBot.getStickerSet(const Name: string): TtdStickerSet;
begin
...
function TInjectTelegramBot.SendInvoice(const ChatId: Int64; const Title: string;
  ...
  TtdLabeledPrice>; const ProviderData: string; const PhotoUrl: string; const
