...
{$REGION 'Getting updates'}
    ...
    /// back to getUpdates.
    /// <see cref="TelegAPI.Bot|TTelegramBot.GetUpdates(Int64,Int64,Int64,TAllowedUpdates)">
    /// getUpdates</see>.
    /// </summary>
    /// <param name="drop_pending_updates">
    /// </param>
    ...
    /// </summary>
    /// <returns>
    /// On success, returns a <see cref="TelegAPi.Types|TtdWebhookInfo">
...
{$REGION 'Basic methods'}
    ...
    /// </para>
    /// <para>
    /// Returns basic information about the bot in form of a <see cref="TelegAPi.Types|TtdUser">
    /// User</see> object.
    /// </para>
    /// </returns>
    ...
    /// </param>
    /// <returns>
    /// On success, the sent <see cref="TelegAPi.Types|TtdMessage">Message</see>
    /// is returned.
    /// </returns>
    /// <example>
    ...
    /// </param>
    /// <returns>
    /// On success, the sent <see cref="TelegAPi.Types|ItdMessage">Message</see>
    /// is returned.
    /// </returns>
    /// <remarks>
    ...
    function SendVenue( //
      ...
      const Location: TtdLocation; //Add Para Testes
      const DisableNotification: Boolean = False; //
      const ReplyToMessageId: Int64 = 0; //
      const AllowSendingWithoutReply:	Boolean = False;
      ReplyMarkup: IReplyMarkup = nil): ItdMessage;
    ...
    /// </param>
    /// <returns>
    /// Returns a <see cref="TelegAPi.Types|TtdUserProfilePhotos">
    ...
    /// </param>
    /// <returns>
    /// On success, a <see cref="TelegAPi.Types|TtdFile">File</see> object is
    /// returned.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    /// Returns a <see cref="TelegAPi.Types|TtdChat">Chat</see> object on
    /// success.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    /// On success, returns an Array of <see cref="TelegAPi.Types|TtdChatMember">
    ...
    /// </param>
    /// <returns>
    /// Returns a <see cref="TelegAPi.Types|TtdChatMember">ChatMember</see>
    /// object on success.
    /// </returns>
...
{$REGION 'Payments'}
    ...
    /// </param>
    /// <returns>
    /// On success, the sent <see cref="TelegAPi.Types|ItdMessage" /> is
    /// returned.
    /// </returns>
    ...
    /// Bot API sends the final confirmation in the form of an <see cref="TelegAPi.Types|TtdUpdate">
...
{$REGION 'Games'}
    ...
    /// </param>
    /// <returns>
    /// On success, returns an Array of <see cref="TelegAPi.Types|TtdGameHighScore">
...
{$REGION 'Strickers'}
    ...
    /// </param>
    /// <returns>
    /// On success, a <see cref="TelegAPi.Types|TtdStickerSet">StickerSet</see>
    /// object is returned.
    /// </returns>
    function getStickerSet(const Name: string): TtdStickerSet;
    /// <summary>
    /// Use this method to upload a .png file with a sticker for later use in
    /// <see cref="TelegAPI.Bot|TTelegramBot.createNewStickerSet(Int64,string,string,TValue,string,Boolean,TtdMaskPosition)">
    /// createNewStickerSet</see> and <see cref="TelegAPI.Bot|TTelegramBot.addStickerToSet(Int64,string,TValue,string,TtdMaskPosition)">
    ...
    /// </param>
    /// <returns>
    /// Returns the uploaded <see cref="TelegAPi.Types|TtdFile">File</see> on
    /// success.
    /// </returns>
    ...
    /// <remarks>
    /// The bot must be an administrator in the chat for this to work and
    /// must have the appropriate admin rights. Use the field <see cref="TelegAPi.Types|TtdChat.CanSetStickerSet">
